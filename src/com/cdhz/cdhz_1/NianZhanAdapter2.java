...
import com.hyc.androidcore.comm.BaseAdapterHelper;
...
public class NianZhanAdapter2 extends BaseAdapterHelper {


	public NianZhanAdapter2(Activity activity, JSONArray data) {
		super(activity, data);
	}
