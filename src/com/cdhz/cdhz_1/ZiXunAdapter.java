...
public class ZiXunAdapter extends BaseListViewPageAdapter {

	public ZiXunAdapter(Context context, RefreshListView listView,
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		if(arg1==null){
			arg1=LayoutInflater.from(mContext).inflate(R.layout.item_zixun, null);
		...
		vh.time.setText(formatTime(mData.optJSONObject(arg0).optString("createDate")));
		return arg1;
	}
